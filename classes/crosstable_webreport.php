...
class CrossTableWebReport
{
	...
	{					
		...
		return "Γκρουπ X"
			.":<b>".$this->xml_array["totals"][ $fieldNameX ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Γκρουπ Y"
			.":<b>".$this->xml_array["totals"][ $fieldNameY ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Πεδίο"
			.":<b>".$this->xml_array["totals"][ $fieldName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Γκρουπ Συνάρτηση"
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("dbo.Calls" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.denialReason" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callStatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.CallCenter_audit" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.voltonApplications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Items" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.orderItems" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.postalCodes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.itemFamily" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.itemSalesCategory" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.itemCustomer" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.contacts" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.phoneTypes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callClassifications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callSubClassifications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.contactAddresses" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Items" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.CallCenter_settings" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.internalComments" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callStatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.applicationStatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.novaApplications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.voltonPowerPlans" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.agentApplicationStatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.CallCenter_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callcenter_ugmembers" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callcenter_uggroups" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.callcenter_ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Items" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.itemSearch" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.manualCalls" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Calls" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Calls" == $this->xml_array['tables'][0])
		...
		if("dbo.agentApplicationStatus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.campaignsLastThreeMonths" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.listsLastThreeMonths" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.courierCompanies" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.novaApplications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.contactMethods" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.voltonApplications" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.voltonApplications" == $this->xml_array['tables'][0])
		...
		if("dbo.CallCenter_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithApps" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithApps" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->xml_array['tables'][0])
		...
		if("" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithNovaAppsV3" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.vAgentPerformanceReportWithNovaAppsV3" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
