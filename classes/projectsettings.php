...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("dbo.CallCenter_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "dbo.Calls" ] = array( "url" => "calls", "type" => 0 );
	$projectEntitiesReverse[ "calls" ] = "dbo.Calls";
	$projectEntities[ "dbo.denialReason" ] = array( "url" => "denialreason", "type" => 0 );
	$projectEntitiesReverse[ "denialreason" ] = "dbo.denialReason";
	$projectEntities[ "dbo.callStatus" ] = array( "url" => "callstatus", "type" => 0 );
	$projectEntitiesReverse[ "callstatus" ] = "dbo.callStatus";
	$projectEntities[ "dbo.CallCenter_audit" ] = array( "url" => "callcenter_audit", "type" => 0 );
	$projectEntitiesReverse[ "callcenter_audit" ] = "dbo.CallCenter_audit";
	$projectEntities[ "dbo.voltonApplications" ] = array( "url" => "dbo_voltonapplications", "type" => 0 );
	$projectEntitiesReverse[ "dbo_voltonapplications" ] = "dbo.voltonApplications";
	$projectEntities[ "dbo.Items" ] = array( "url" => "items", "type" => 0 );
	$projectEntitiesReverse[ "items" ] = "dbo.Items";
	$projectEntities[ "dbo.orderItems" ] = array( "url" => "orderitems", "type" => 0 );
	$projectEntitiesReverse[ "orderitems" ] = "dbo.orderItems";
	$projectEntities[ "dbo.postalCodes" ] = array( "url" => "postalcodes", "type" => 0 );
	$projectEntitiesReverse[ "postalcodes" ] = "dbo.postalCodes";
	$projectEntities[ "dbo.itemFamily" ] = array( "url" => "itemfamily", "type" => 0 );
	$projectEntitiesReverse[ "itemfamily" ] = "dbo.itemFamily";
	$projectEntities[ "dbo.itemSalesCategory" ] = array( "url" => "itemsalescategory", "type" => 0 );
	$projectEntitiesReverse[ "itemsalescategory" ] = "dbo.itemSalesCategory";
	$projectEntities[ "dbo.itemCustomer" ] = array( "url" => "itemcustomer", "type" => 0 );
	$projectEntitiesReverse[ "itemcustomer" ] = "dbo.itemCustomer";
	$projectEntities[ "dbo.contacts" ] = array( "url" => "dbo_contacts", "type" => 0 );
	$projectEntitiesReverse[ "dbo_contacts" ] = "dbo.contacts";
	$projectEntities[ "dbo.phoneTypes" ] = array( "url" => "dbo_phonetypes", "type" => 0 );
	$projectEntitiesReverse[ "dbo_phonetypes" ] = "dbo.phoneTypes";
	$projectEntities[ "dbo.callClassifications" ] = array( "url" => "dbo_callclassifications", "type" => 0 );
	$projectEntitiesReverse[ "dbo_callclassifications" ] = "dbo.callClassifications";
	$projectEntities[ "dbo.callSubClassifications" ] = array( "url" => "callsubclassifications", "type" => 0 );
	$projectEntitiesReverse[ "callsubclassifications" ] = "dbo.callSubClassifications";
	$projectEntities[ "dbo.contactAddresses" ] = array( "url" => "contactaddresses", "type" => 0 );
	$projectEntitiesReverse[ "contactaddresses" ] = "dbo.contactAddresses";
	$projectEntities[ "itemLookup" ] = array( "url" => "itemlookup", "type" => 1 );
	$projectEntitiesReverse[ "itemlookup" ] = "itemLookup";
	$projectEntities[ "dbo.CallCenter_settings" ] = array( "url" => "callcenter_settings", "type" => 0 );
	$projectEntitiesReverse[ "callcenter_settings" ] = "dbo.CallCenter_settings";
	$projectEntities[ "dbo.internalComments" ] = array( "url" => "internalcomments", "type" => 0 );
	$projectEntitiesReverse[ "internalcomments" ] = "dbo.internalComments";
	$projectEntities[ "dbo.callStatusLookup" ] = array( "url" => "dbo_callstatuslookup", "type" => 1 );
	$projectEntitiesReverse[ "dbo_callstatuslookup" ] = "dbo.callStatusLookup";
	$projectEntities[ "dbo.applicationStatus" ] = array( "url" => "applicationstatus", "type" => 0 );
	$projectEntitiesReverse[ "applicationstatus" ] = "dbo.applicationStatus";
	$projectEntities[ "dbo.novaApplications" ] = array( "url" => "novaapplications", "type" => 0 );
	$projectEntitiesReverse[ "novaapplications" ] = "dbo.novaApplications";
	$projectEntities[ "dbo.voltonPowerPlans" ] = array( "url" => "voltonpowerplans", "type" => 0 );
	$projectEntitiesReverse[ "voltonpowerplans" ] = "dbo.voltonPowerPlans";
	$projectEntities[ "dbo.agentApplicationStatus" ] = array( "url" => "agentapplicationstatus", "type" => 0 );
	$projectEntitiesReverse[ "agentapplicationstatus" ] = "dbo.agentApplicationStatus";
	$projectEntities[ "dbo.CallCenter_users" ] = array( "url" => "dbo_callcenter_users", "type" => 0 );
	$projectEntitiesReverse[ "dbo_callcenter_users" ] = "dbo.CallCenter_users";
	$projectEntities[ "dbo.callcenter_ugmembers" ] = array( "url" => "callcenter_ugmembers", "type" => 0 );
	$projectEntitiesReverse[ "callcenter_ugmembers" ] = "dbo.callcenter_ugmembers";
	$projectEntities[ "dbo.callcenter_uggroups" ] = array( "url" => "callcenter_uggroups", "type" => 0 );
	$projectEntitiesReverse[ "callcenter_uggroups" ] = "dbo.callcenter_uggroups";
	$projectEntities[ "dbo.callcenter_ugrights" ] = array( "url" => "callcenter_ugrights", "type" => 1 );
	$projectEntitiesReverse[ "callcenter_ugrights" ] = "dbo.callcenter_ugrights";
	$projectEntities[ "itemLookup1" ] = array( "url" => "itemlookup1", "type" => 1 );
	$projectEntitiesReverse[ "itemlookup1" ] = "itemLookup1";
	$projectEntities[ "dbo.itemSearch" ] = array( "url" => "itemsearch", "type" => 0 );
	$projectEntitiesReverse[ "itemsearch" ] = "dbo.itemSearch";
	$projectEntities[ "dbo.manualCalls" ] = array( "url" => "manualcalls", "type" => 0 );
	$projectEntitiesReverse[ "manualcalls" ] = "dbo.manualCalls";
	$projectEntities[ "callsForRedial" ] = array( "url" => "callsforredial", "type" => 1 );
	$projectEntitiesReverse[ "callsforredial" ] = "callsForRedial";
	$projectEntities[ "upcomingCallsForRedial" ] = array( "url" => "upcomingcallsforredial", "type" => 1 );
	$projectEntitiesReverse[ "upcomingcallsforredial" ] = "upcomingCallsForRedial";
	$projectEntities[ "dbo.voltonAgentApplications" ] = array( "url" => "voltonagentapplications", "type" => 1 );
	$projectEntitiesReverse[ "voltonagentapplications" ] = "dbo.voltonAgentApplications";
	$projectEntities[ "dbo.CallsBackofficeView" ] = array( "url" => "callsbackofficeview", "type" => 1 );
	$projectEntitiesReverse[ "callsbackofficeview" ] = "dbo.CallsBackofficeView";
	$projectEntities[ "dbo.voltonApplicationsBackofficeView" ] = array( "url" => "voltonapplicationsbackofficeview", "type" => 1 );
	$projectEntitiesReverse[ "voltonapplicationsbackofficeview" ] = "dbo.voltonApplicationsBackofficeView";
	$projectEntities[ "dbo.novaApplicationsBackofficeView" ] = array( "url" => "novaapplicationsbackofficeview", "type" => 1 );
	$projectEntitiesReverse[ "novaapplicationsbackofficeview" ] = "dbo.novaApplicationsBackofficeView";
	$projectEntities[ "callsNegativeReport" ] = array( "url" => "callsnegativereport", "type" => 2 );
	$projectEntitiesReverse[ "callsnegativereport" ] = "callsNegativeReport";
	$projectEntities[ "dbo.campaignsLastThreeMonths" ] = array( "url" => "campaignslastthreemonths", "type" => 0 );
	$projectEntitiesReverse[ "campaignslastthreemonths" ] = "dbo.campaignsLastThreeMonths";
	$projectEntities[ "dbo.listsLastThreeMonths" ] = array( "url" => "listslastthreemonths", "type" => 0 );
	$projectEntitiesReverse[ "listslastthreemonths" ] = "dbo.listsLastThreeMonths";
	$projectEntities[ "dbo.courierCompanies" ] = array( "url" => "couriercompanies", "type" => 0 );
	$projectEntitiesReverse[ "couriercompanies" ] = "dbo.courierCompanies";
	$projectEntities[ "dbo.novaAgentApplications" ] = array( "url" => "novaagentapplications", "type" => 1 );
	$projectEntitiesReverse[ "novaagentapplications" ] = "dbo.novaAgentApplications";
	$projectEntities[ "dbo.contactMethods" ] = array( "url" => "contactmethods", "type" => 0 );
	$projectEntitiesReverse[ "contactmethods" ] = "dbo.contactMethods";
	$projectEntities[ "dbo.voltonApplicationsStatusView" ] = array( "url" => "dbo_voltonapplicationsstatusview", "type" => 1 );
	$projectEntitiesReverse[ "dbo_voltonapplicationsstatusview" ] = "dbo.voltonApplicationsStatusView";
	$projectEntities[ "dbo.voltonApplications Status Report" ] = array( "url" => "dbo_voltonapplications_status_report", "type" => 2 );
	$projectEntitiesReverse[ "dbo_voltonapplications_status_report" ] = "dbo.voltonApplications Status Report";
	$projectEntities[ "dbo.novaApplicationsStatusView" ] = array( "url" => "dbo_novaapplicationsstatusview", "type" => 1 );
	$projectEntitiesReverse[ "dbo_novaapplicationsstatusview" ] = "dbo.novaApplicationsStatusView";
	$projectEntities[ "dbo.novaApplications Status Report" ] = array( "url" => "novaapplications_status_report", "type" => 2 );
	$projectEntitiesReverse[ "novaapplications_status_report" ] = "dbo.novaApplications Status Report";
	$projectEntities[ "callsAgentView" ] = array( "url" => "callsagentview", "type" => 1 );
	$projectEntitiesReverse[ "callsagentview" ] = "callsAgentView";
	...
	$projectEntities[ "dbo.vAgentPerformanceReportWithApps" ] = array( "url" => "vagentperformancereportwithapps", "type" => 0 );
	$projectEntitiesReverse[ "vagentperformancereportwithapps" ] = "dbo.vAgentPerformanceReportWithApps";
	$projectEntities[ "Agent Performance Report" ] = array( "url" => "agent_performance_report", "type" => 2 );
	$projectEntitiesReverse[ "agent_performance_report" ] = "Agent Performance Report";
	$projectEntities[ "dbo.vAgentPerformanceReportWithAppsV2" ] = array( "url" => "vagentperformancereportwithappsv2", "type" => 0 );
	$projectEntitiesReverse[ "vagentperformancereportwithappsv2" ] = "dbo.vAgentPerformanceReportWithAppsV2";
	$projectEntities[ "vAgentPerformanceReport v2" ] = array( "url" => "vagentperformancereport_v2", "type" => 2 );
	$projectEntitiesReverse[ "vagentperformancereport_v2" ] = "vAgentPerformanceReport v2";
	$projectEntities[ "dbo.vAgentPerformanceReportWithAppsV21" ] = array( "url" => "vagentperformancereportwithappsv21", "type" => 1 );
	$projectEntitiesReverse[ "vagentperformancereportwithappsv21" ] = "dbo.vAgentPerformanceReportWithAppsV21";
	$projectEntities[ "Agent Performance Dashboard" ] = array( "url" => "agent_performance_dashboard", "type" => 4 );
	$projectEntitiesReverse[ "agent_performance_dashboard" ] = "Agent Performance Dashboard";
	$projectEntities[ "dbo.vAgentPerformanceReportWithNovaAppsV3" ] = array( "url" => "vagentperformancereportwithnovaappsv3", "type" => 0 );
	$projectEntitiesReverse[ "vagentperformancereportwithnovaappsv3" ] = "dbo.vAgentPerformanceReportWithNovaAppsV3";
	$projectEntities[ "dbo.vAgentPerformanceReportWithNovaAppsV3 Report" ] = array( "url" => "vagentperformancereportwithnovaappsv3_report", "type" => 2 );
	$projectEntitiesReverse[ "vagentperformancereportwithnovaappsv3_report" ] = "dbo.vAgentPerformanceReportWithNovaAppsV3 Report";
}
