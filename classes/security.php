...
class Security
{
	...
	{
		echo printJSON(array("success" => false, "message" => "Δεν έχετε δικαιώματα για αυτό το πεδίο".$message));
		exit();
	}
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "dbo.callcenter_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
