...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("dbo.Calls" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.denialReason" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callStatus" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.CallCenter_audit" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.voltonApplications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Items" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.orderItems" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.postalCodes" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.itemFamily" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.itemSalesCategory" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.itemCustomer" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.contacts" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.phoneTypes" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callClassifications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callSubClassifications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.contactAddresses" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Items" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.CallCenter_settings" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.internalComments" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callStatus" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.applicationStatus" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.novaApplications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.voltonPowerPlans" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.agentApplicationStatus" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.CallCenter_users" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callcenter_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callcenter_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.callcenter_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Items" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.itemSearch" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.manualCalls" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Calls" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Calls" == $this->chrt_array['tables'][0])
		...
		if("dbo.agentApplicationStatus" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.campaignsLastThreeMonths" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.listsLastThreeMonths" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.courierCompanies" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.novaApplications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.contactMethods" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.voltonApplications" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.voltonApplications" == $this->chrt_array['tables'][0])
		...
		if("dbo.CallCenter_users" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithApps" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithApps" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithAppsV2" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithNovaAppsV3" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.vAgentPerformanceReportWithNovaAppsV3" == $this->chrt_array['tables'][0])
			return true;
		return false;
