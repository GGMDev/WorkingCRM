...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[CONTAINS] = "Περιέχει";
		$this->searchOptions[EQUALS] = "Ίσο";
		$this->searchOptions[STARTS_WITH] = "Αρχή μέ";
		$this->searchOptions[MORE_THAN] = "Περισσότερο από";
		$this->searchOptions[LESS_THAN] = "Mικρότερο από";
		$this->searchOptions[BETWEEN] = "Ανάμεσα";
		$this->searchOptions[EMPTY_SEARCH] = "Κενό";
		$this->searchOptions[NOT_CONTAINS] = "Δεν περιέχει";
		$this->searchOptions[NOT_EQUALS] = "Δεν είναι ίσο";
		$this->searchOptions[NOT_STARTS_WITH] = "Δεν ξεκινάει με";
		$this->searchOptions[NOT_MORE_THAN] = "Δεν είναι μεγαλύτερο από";
		$this->searchOptions[NOT_LESS_THAN] = "Δεν είναι μικρότερο από";
		$this->searchOptions[NOT_BETWEEN] = "Δεν είναι ανάμεσα σε";
		$this->searchOptions[NOT_EMPTY] = "Δεν είναι κενό";
