...
require_once("include/agenttotalsperdayandstatus_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "agentTotalsPerDayAndStatus" );
