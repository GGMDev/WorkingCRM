...
require_once("include/agentvoltonapplicationswithstatus_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "agentVoltonApplicationsWithStatus" );
