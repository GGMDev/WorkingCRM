...
require_once("include/agentcallstatusanalysis_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "AgentCallStatusAnalysis" );
