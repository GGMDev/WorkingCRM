...
elseif (postvalue("cname")) 
{
	...
	if(!isLogged()) {					
		...
		echo "<p>"."Δεν έχετε τα δικαιώματα να δείτε αυτή την αναφορά"."</p>";
		exit();
	}
...
$jscode.="TEXT_MONTH_JAN='".jsreplace("Ιανουάριος")."';\r\n";
$jscode.="TEXT_MONTH_FEB='".jsreplace("Φεβρουάριος")."';\r\n";
$jscode.="TEXT_MONTH_MAR='".jsreplace("Μάρτιος")."';\r\n";
$jscode.="TEXT_MONTH_APR='".jsreplace("Απρίλιος")."';\r\n";
$jscode.="TEXT_MONTH_MAY='".jsreplace("Μάιος")."';\r\n";
$jscode.="TEXT_MONTH_JUN='".jsreplace("Ιούνιος")."';\r\n";
$jscode.="TEXT_MONTH_JUL='".jsreplace("Ιούλιος")."';\r\n";
$jscode.="TEXT_MONTH_AUG='".jsreplace("Αύγουστος")."';\r\n";
$jscode.="TEXT_MONTH_SEP='".jsreplace("Σεπτέμβριος")."';\r\n";
$jscode.="TEXT_MONTH_OCT='".jsreplace("Οκτώβριος")."';\r\n";
$jscode.="TEXT_MONTH_NOV='".jsreplace("Νοέμβριος")."';\r\n";
$jscode.="TEXT_MONTH_DEC='".jsreplace("Δεκέμβριος")."';\r\n";

$jscode.="TEXT_DAY_SU='".jsreplace("ΚΥ")."';\r\n";
$jscode.="TEXT_DAY_MO='".jsreplace("ΔΕ")."';\r\n";
$jscode.="TEXT_DAY_TU='".jsreplace("ΤΡ")."';\r\n";
$jscode.="TEXT_DAY_WE='".jsreplace("ΤΕ")."';\r\n";
$jscode.="TEXT_DAY_TH='".jsreplace("ΠΕ")."';\r\n";
$jscode.="TEXT_DAY_FR='".jsreplace("ΠΑ")."';\r\n";
$jscode.="TEXT_DAY_SA='".jsreplace("ΣΑ")."';\r\n";

$jscode.="TEXT_TODAY='".jsreplace("σήμερα")."';\r\n";
$jscode .= '
locale_dateformat = "'.$locale_info["LOCALE_IDATE"].'";
locale_datedelimiter = "'.$locale_info["LOCALE_SDATE"].'";
bLoading = false;
TEXT_PLEASE_SELECT = "'.jsreplace("Παρακαλώ επιλέξτε").'"; 
