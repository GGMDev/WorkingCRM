...
require_once("include/dbo_novaapplicationsstatusview_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.novaApplicationsStatusView" );
