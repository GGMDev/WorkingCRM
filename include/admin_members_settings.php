...
$tdataadmin_members[".OriginalTable"] = "dbo.CallCenter_users";
...
if(mlang_getcurrentlang()=="Greek")
{
	...
	$fieldLabelsadmin_members["Greek"]["ID"] = "ID";
	$fieldToolTipsadmin_members["Greek"]["ID"] = "";
	$placeHoldersadmin_members["Greek"]["ID"] = "";
	$fieldLabelsadmin_members["Greek"]["username"] = "Username";
	$fieldToolTipsadmin_members["Greek"]["username"] = "";
	$placeHoldersadmin_members["Greek"]["username"] = "";
	$fieldLabelsadmin_members["Greek"]["password"] = "Password";
	$fieldToolTipsadmin_members["Greek"]["password"] = "";
	$placeHoldersadmin_members["Greek"]["password"] = "";
	$fieldLabelsadmin_members["Greek"]["email"] = "Email";
	$fieldToolTipsadmin_members["Greek"]["email"] = "";
	$placeHoldersadmin_members["Greek"]["email"] = "";
	$fieldLabelsadmin_members["Greek"]["fullname"] = "Fullname";
	$fieldToolTipsadmin_members["Greek"]["fullname"] = "";
	$placeHoldersadmin_members["Greek"]["fullname"] = "";
	$fieldLabelsadmin_members["Greek"]["groupid"] = "Groupid";
	$fieldToolTipsadmin_members["Greek"]["groupid"] = "";
	$placeHoldersadmin_members["Greek"]["groupid"] = "";
	$fieldLabelsadmin_members["Greek"]["active"] = "Active";
	$fieldToolTipsadmin_members["Greek"]["active"] = "";
	$placeHoldersadmin_members["Greek"]["active"] = "";
	$fieldLabelsadmin_members["Greek"]["ext_security_id"] = "Ext Security Id";
	$fieldToolTipsadmin_members["Greek"]["ext_security_id"] = "";
	$placeHoldersadmin_members["Greek"]["ext_security_id"] = "";
...
$tdataadmin_members[".connId"] = "CallCenter_at_10_41_2_31";


$tdataadmin_members[".strOriginalTableName"] = "dbo.CallCenter_users";
...
$tdataadmin_members[".sqlFrom"] = "FROM dbo.CallCenter_users";
