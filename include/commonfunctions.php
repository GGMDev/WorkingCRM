...
function checkTableName($shortTName )
{
	...
	if ("calls" == $shortTName )
		return true;
	if ("denialreason" == $shortTName )
		return true;
	if ("callstatus" == $shortTName )
		return true;
	if ("callcenter_audit" == $shortTName )
		return true;
	if ("dbo_voltonapplications" == $shortTName )
		return true;
	if ("items" == $shortTName )
		return true;
	if ("orderitems" == $shortTName )
		return true;
	if ("postalcodes" == $shortTName )
		return true;
	if ("itemfamily" == $shortTName )
		return true;
	if ("itemsalescategory" == $shortTName )
		return true;
	if ("itemcustomer" == $shortTName )
		return true;
	if ("dbo_contacts" == $shortTName )
		return true;
	if ("dbo_phonetypes" == $shortTName )
		return true;
	if ("dbo_callclassifications" == $shortTName )
		return true;
	if ("callsubclassifications" == $shortTName )
		return true;
	if ("contactaddresses" == $shortTName )
		return true;
	if ("itemlookup" == $shortTName )
		return true;
	if ("callcenter_settings" == $shortTName )
		return true;
	if ("internalcomments" == $shortTName )
		return true;
	if ("dbo_callstatuslookup" == $shortTName )
		return true;
	if ("applicationstatus" == $shortTName )
		return true;
	if ("novaapplications" == $shortTName )
		return true;
	if ("voltonpowerplans" == $shortTName )
		return true;
	if ("agentapplicationstatus" == $shortTName )
		return true;
	if ("dbo_callcenter_users" == $shortTName )
		return true;
	if ("callcenter_ugmembers" == $shortTName )
		return true;
	if ("callcenter_uggroups" == $shortTName )
		return true;
	if ("callcenter_ugrights" == $shortTName )
		return true;
	if ("itemlookup1" == $shortTName )
		return true;
	if ("itemsearch" == $shortTName )
		return true;
	if ("manualcalls" == $shortTName )
		return true;
	if ("callsforredial" == $shortTName )
		return true;
	if ("upcomingcallsforredial" == $shortTName )
		return true;
	if ("voltonagentapplications" == $shortTName )
		return true;
	if ("callsbackofficeview" == $shortTName )
		return true;
	if ("voltonapplicationsbackofficeview" == $shortTName )
		return true;
	if ("novaapplicationsbackofficeview" == $shortTName )
		return true;
	if ("callsnegativereport" == $shortTName )
		return true;
	if ("campaignslastthreemonths" == $shortTName )
		return true;
	if ("listslastthreemonths" == $shortTName )
		return true;
	if ("couriercompanies" == $shortTName )
		return true;
	if ("novaagentapplications" == $shortTName )
		return true;
	if ("contactmethods" == $shortTName )
		return true;
	if ("dbo_voltonapplicationsstatusview" == $shortTName )
		return true;
	if ("dbo_voltonapplications_status_report" == $shortTName )
		return true;
	if ("dbo_novaapplicationsstatusview" == $shortTName )
		return true;
	if ("novaapplications_status_report" == $shortTName )
		return true;
	if ("callsagentview" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("vagentperformancereportwithapps" == $shortTName )
		return true;
	if ("agent_performance_report" == $shortTName )
		return true;
	if ("vagentperformancereportwithappsv2" == $shortTName )
		return true;
	if ("vagentperformancereport_v2" == $shortTName )
		return true;
	if ("vagentperformancereportwithappsv21" == $shortTName )
		return true;
	if ("agent_performance_dashboard" == $shortTName )
		return true;
	if ("vagentperformancereportwithnovaappsv3" == $shortTName )
		return true;
	if ("vagentperformancereportwithnovaappsv3_report" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.Calls");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.denialReason");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.denialReason";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callStatus");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.CallCenter_audit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.CallCenter_audit";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonApplications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonApplications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.Items");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.orderItems");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.postalCodes");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.itemFamily");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.itemSalesCategory");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.itemSalesCategory";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.itemCustomer");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.itemCustomer";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.contacts");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.phoneTypes");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callClassifications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callClassifications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callSubClassifications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callSubClassifications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.contactAddresses");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.contactAddresses";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("itemLookup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.CallCenter_settings");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.CallCenter_settings";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.internalComments");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.internalComments";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callStatusLookup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callStatusLookup";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.applicationStatus");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.applicationStatus";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.novaApplications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.novaApplications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonPowerPlans");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonPowerPlans";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.agentApplicationStatus");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.agentApplicationStatus";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.CallCenter_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.CallCenter_users";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callcenter_ugmembers");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callcenter_ugmembers";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callcenter_uggroups");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callcenter_uggroups";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.callcenter_ugrights");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.callcenter_ugrights";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("itemLookup1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.itemSearch");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.manualCalls");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("callsForRedial");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("upcomingCallsForRedial");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="upcomingCallsForRedial";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonAgentApplications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonAgentApplications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.CallsBackofficeView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.CallsBackofficeView";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonApplicationsBackofficeView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonApplicationsBackofficeView";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.novaApplicationsBackofficeView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.novaApplicationsBackofficeView";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("callsNegativeReport");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="callsNegativeReport";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.campaignsLastThreeMonths");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.campaignsLastThreeMonths";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.listsLastThreeMonths");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.listsLastThreeMonths";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.courierCompanies");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.courierCompanies";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.novaAgentApplications");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.novaAgentApplications";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.contactMethods");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.contactMethods";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonApplicationsStatusView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonApplicationsStatusView";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.voltonApplications Status Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.voltonApplications Status Report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.novaApplicationsStatusView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.novaApplicationsStatusView";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.novaApplications Status Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.novaApplications Status Report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("callsAgentView");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.vAgentPerformanceReportWithApps");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.vAgentPerformanceReportWithApps";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Agent Performance Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Agent Performance Report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.vAgentPerformanceReportWithAppsV2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.vAgentPerformanceReportWithAppsV2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vAgentPerformanceReport v2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vAgentPerformanceReport v2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.vAgentPerformanceReportWithAppsV21");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.vAgentPerformanceReportWithAppsV21";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Agent Performance Dashboard");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Agent Performance Dashboard";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.vAgentPerformanceReportWithNovaAppsV3");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.vAgentPerformanceReportWithNovaAppsV3";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("dbo.vAgentPerformanceReportWithNovaAppsV3 Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="dbo.vAgentPerformanceReportWithNovaAppsV3 Report";
	}
	return $arr;
}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "dbo.callcenter_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "dbo.callcenter_ugrights" )
...
function GetUserPermissionsStatic( $table )
{
	...
	if( $table=="dbo.Calls" )
	{
		...
		if( $sUserGroup=="supervisors" )
		{
			return "AEDSPI".$extraPerm;
		}
		if( $sUserGroup=="backoffice" )
		{
			return "AEDSPI".$extraPerm;
		}
		if( $sUserGroup=="administrators" )
		{
			return "AEDSPI".$extraPerm;
		}
//	default permissions
...
//	default permissions
	...
	if( $table=="dbo.voltonApplications" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.itemSalesCategory" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.callClassifications" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.callSubClassifications" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.CallCenter_settings" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.applicationStatus" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.agentApplicationStatus" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.callcenter_ugmembers" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.callcenter_uggroups" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.callcenter_ugrights" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="upcomingCallsForRedial" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.voltonAgentApplications" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.CallsBackofficeView" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.voltonApplicationsBackofficeView" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.novaApplicationsBackofficeView" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.campaignsLastThreeMonths" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.listsLastThreeMonths" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.novaAgentApplications" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.voltonApplicationsStatusView" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.voltonApplications Status Report" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.novaApplicationsStatusView" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.novaApplications Status Report" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.vAgentPerformanceReportWithApps" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="Agent Performance Report" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.vAgentPerformanceReportWithAppsV2" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="vAgentPerformanceReport v2" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.vAgentPerformanceReportWithAppsV21" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="Agent Performance Dashboard" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.vAgentPerformanceReportWithNovaAppsV3" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="dbo.vAgentPerformanceReportWithNovaAppsV3 Report" )
	{
		if( $sUserGroup=="<Guest>" )
		{
			return "S".$extraPerm;
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_dbo.Calls_OwnerID"] = $data["username"];
		$_SESSION["_dbo.internalComments_OwnerID"] = $data["active"];
		$_SESSION["_dbo.callcenter_ugmembers_OwnerID"] = $data["active"];
		$_SESSION["_callsForRedial_OwnerID"] = $data["username"];
		$_SESSION["_upcomingCallsForRedial_OwnerID"] = $data["username"];
		$_SESSION["_dbo.CallsBackofficeView_OwnerID"] = $data["username"];
		$_SESSION["_callsAgentView_OwnerID"] = $data["username"];
...
function SetLangVars($xt, $prefix, $pageName = "", $extraparams = "")
{
	...
	$xt->assign("GreekLANGLINK", "Greek" != $currentLang);
...
function getMountNames()
{
	...
	$mounts[7] = "Ιούλιος";
	$mounts[8] = "Αύγουστος";
	$mounts[9] = "Σεπτέμβριος";
	$mounts[10] = "Οκτώβριος";
	$mounts[11] = "Νοέμβριος";
	$mounts[12] = "Δεκέμβριος";
...
function GetBaseScriptsForPage($isDisplayLoading, $additionalScripts = "", $customText = "")
{
	...
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/custom_functions.js?34702")."\"></script>";
...
function getIntervalLimitsExprs($table, $field, $idx, $isLowerBound)
{
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 1)
	{
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 2)
	{
		//get the expression for a lower bound
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 3)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()-86400)
		;
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 4)
	{
		//get the expression for a lower bound
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 5)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m") - 1, 1, date("Y")))
		;
	...
	if($table=="dbo.Calls" && $field=="callDate" && $isLowerBound && $idx == 6)
	{
		//get the expression for a lower bound
	...
	if($table=="dbo.Calls" && $field=="callDate" && !$isLowerBound && $idx == 7)
	{
		//get the expression for an upper bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 1)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()+86400)
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 2)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time())
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 3)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()-86400)
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 4)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m"), 1, date("Y")))
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 5)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m") - 1, 1, date("Y")))
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && $isLowerBound && $idx == 6)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="callsForRedial" && $field=="callDate" && !$isLowerBound && $idx == 7)
	{
		//get the expression for an upper bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 1)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()+86400)
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 2)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time())
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 3)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()-86400)
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 4)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m"), 1, date("Y")))
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 5)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m") - 1, 1, date("Y")))
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && $isLowerBound && $idx == 6)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="upcomingCallsForRedial" && $field=="callDate" && !$isLowerBound && $idx == 7)
	{
		//get the expression for an upper bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 1)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()+86400)
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 2)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time())
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 3)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()-86400)
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 4)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m"), 1, date("Y")))
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 5)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m") - 1, 1, date("Y")))
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && $isLowerBound && $idx == 6)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="dbo.CallsBackofficeView" && $field=="callDate" && !$isLowerBound && $idx == 7)
	{
		//get the expression for an upper bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 1)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()+86400)
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 2)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time())
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 3)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", time()-86400)
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 4)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m"), 1, date("Y")))
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 5)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, date("m") - 1, 1, date("Y")))
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && $isLowerBound && $idx == 6)
	{
		//get the expression for a lower bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
	...
	if($table=="callsAgentView" && $field=="callDate" && !$isLowerBound && $idx == 7)
	{
		//get the expression for an upper bound
		$value = date("Y-m-d", mktime(0,0,0, 1, 1, date("Y")))
		;
...
function verifyRecaptchaResponse( $response ) {
	...
	$errors = array();
	$errors["missing-input-response"] = "Ο κωδικός επιβεβαίωσης δεν είναι σωστός";
	$errors["invalid-input-response"] = "Ο κωδικός επιβεβαίωσης δεν είναι σωστός";
