...
function GetUserGroups() {
	...
	$qResult = $grConnection->query("select ".$grConnection->addFieldWrappers("GroupID")
		.", ".$grConnection->addFieldWrappers("Label")." from ".$grConnection->addTableWrappers("dbo.callcenter_uggroups")
...
function getCaptionTable($table)
{
	...
	if($table=="dbo.callClassifications")
	{
		return "Call Classifications";
	}
	if($table=="dbo.callSubClassifications")
	{
		return "Call Sub Classifications";
	}
	if($table=="dbo.contactAddresses")
	{
	...
	if($table=="dbo.voltonPowerPlans")
	{
		return "Volton Power Plans";
	}
	if($table=="dbo.agentApplicationStatus")
	{
		return "Agent Application Status";
	}
	if($table=="dbo.CallCenter_users")
	{
		return "CallCenter Users";
	}
	if($table=="dbo.callcenter_ugmembers")
	{
		return "Callcenter Ugmembers";
	}
	if($table=="dbo.callcenter_uggroups")
	{
		return "Callcenter Uggroups";
	}
	if($table=="dbo.callcenter_ugrights")
	{
		return "Callcenter Ugrights";
	}
	if($table=="itemLookup1")
	{
		return "Item Lookup1";
	...
	if($table=="callsForRedial")
	{
		return "Calls For Redial";
	}
	if($table=="upcomingCallsForRedial")
	{
		return "Upcoming Calls For Redial";
	}
	if($table=="dbo.voltonAgentApplications")
	{
		return "Volton Agent Applications";
	}
	if($table=="dbo.CallsBackofficeView")
	{
		return "Calls Backoffice View";
	}
	if($table=="dbo.voltonApplicationsBackofficeView")
	{
		return "Volton Applications Backoffice View";
	}
	if($table=="dbo.novaApplicationsBackofficeView")
	{
		return "Nova Applications Backoffice View";
	}
	if($table=="callsNegativeReport")
	{
		return "Calls Negative Report";
	}
	if($table=="dbo.campaignsLastThreeMonths")
	{
		return "Campaigns Last Three Months";
	}
	if($table=="dbo.listsLastThreeMonths")
	{
		return "Lists Last Three Months";
	}
	if($table=="dbo.courierCompanies")
	{
	...
	if($table=="dbo.novaAgentApplications")
	{
		return "Nova Agent Applications";
	}
	if($table=="dbo.contactMethods")
	{
	...
	if($table=="dbo.voltonApplicationsStatusView")
	{
		return "Volton Applications Status View";
	}
	if($table=="dbo.voltonApplications Status Report")
	{
		return "voltonApplications Status Report";
	}
	if($table=="dbo.novaApplicationsStatusView")
	{
		return "Nova Applications Status View";
	}
	if($table=="dbo.novaApplications Status Report")
	{
		return "novaApplications Status Report";
	}
	if($table=="callsAgentView")
	{
		return "Calls Agent View";
	}
	if($table=="admin_rights")
	{
		return "Admin Rights";
	...
	if($table=="dbo.vAgentPerformanceReportWithApps")
	{
		return "V Agent Performance Report With Apps";
	}
	if($table=="Agent Performance Report")
	{
	...
	if($table=="dbo.vAgentPerformanceReportWithAppsV2")
	{
		return "V Agent Performance Report With Apps V2";
	}
	if($table=="vAgentPerformanceReport v2")
	{
		return "VAgentPerformanceReport V2";
	}
	if($table=="dbo.vAgentPerformanceReportWithAppsV21")
	{
		return "V Agent Performance Report With Apps V21";
	}
	if($table=="Agent Performance Dashboard")
	{
	...
	if($table=="dbo.vAgentPerformanceReportWithNovaAppsV3")
	{
		return "V Agent Performance Report With Nova Apps V3";
	}
	if($table=="dbo.vAgentPerformanceReportWithNovaAppsV3 Report")
	{
		return "VAgentPerformanceReportWithNovaAppsV3 Report";
	}
	return $table;
}
...
function GetAdvSearchOptions($table,$field)
{
	...
	{
		$options[]=array("type"=>"Equals","label"=>"Ίσο");
		$options[]=array("type"=>"More than ...","label"=>"Περισσότερο από");
		$options[]=array("type"=>"Less than ...","label"=>"Mικρότερο από");
		$options[]=array("type"=>"Equal or more than ...","label"=>"Ίσο ή μεγαλύτερο από...");
		$options[]=array("type"=>"Equal or less than ...","label"=>"Ίσο ή μικρότερο από...");
		$options[]=array("type"=>"Between","label"=>"Ανάμεσα");
		$options[]=array("type"=>"Empty","label"=>"Κενό");
	}
	elseif($format==EDIT_FORMAT_LOOKUP_WIZARD)
	{
		$pSet = new ProjectSettings($table, PAGE_REPORT);
		if($pSet->multiSelect($field))
			$options[]=array("type"=>"Contains","label"=>"Περιέχει");
		else
			$options[]=array("type"=>"Equals","label"=>"Ίσο");
	}
	...
	|| $format==EDIT_FORMAT_READONLY	)
	{
		$options[]=array("type"=>"Contains","label"=>"Περιέχει");
		$options[]=array("type"=>"Equals","label"=>"Ίσο");
		$options[]=array("type"=>"Starts with ...","label"=>"Αρχή μέ");
		$options[]=array("type"=>"More than ...","label"=>"Περισσότερο από");
		$options[]=array("type"=>"Less than ...","label"=>"Mικρότερο από");
		$options[]=array("type"=>"Equal or more than ...","label"=>"Ίσο ή μεγαλύτερο από...");
		$options[]=array("type"=>"Equal or less than ...","label"=>"Ίσο ή μικρότερο από...");
...
function GetTablesListReport()
{
	...
	if($securityFlag)
	{
		$value="dbo.callSubClassifications";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.agentApplicationStatus";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.callcenter_ugmembers";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.voltonAgentApplications";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.voltonApplicationsBackofficeView";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.novaApplicationsBackofficeView";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.campaignsLastThreeMonths";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.listsLastThreeMonths";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.novaAgentApplications";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.voltonApplicationsStatusView";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.novaApplicationsStatusView";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.vAgentPerformanceReportWithApps";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.vAgentPerformanceReportWithAppsV2";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.vAgentPerformanceReportWithAppsV21";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
	...
	if($securityFlag)
	{
		$value="dbo.vAgentPerformanceReportWithNovaAppsV3";
		if(substr($value,-6)!="_audit" && substr($value,-8)!="_locking" && substr($value,-9)!="_ugrights" && substr($value,-9)!="_uggroups" 
		&& substr($value,-10)!="_ugmembers" && $value!="admin_rights" && $value!="admin_users"
		&& $value!="admin_members" && $value!="webreports" && $value!="webreport_style" && $value!="webreport_settings" && $value!="webreport_admin" && $value!="webreport_sql")
