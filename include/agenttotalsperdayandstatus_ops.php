<?php
$topsagenttotalsperdayandstatus = array();
		$topsagenttotalsperdayandstatus["selectList"] = array(
		"subtype" => "sql",
...
"
		...
		$tables_data["agentTotalsPerDayAndStatus"][".operations"] = &$topsagenttotalsperdayandstatus;
?>