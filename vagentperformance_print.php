...
require_once("include/vagentperformance_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.vAgentPerformance" );
