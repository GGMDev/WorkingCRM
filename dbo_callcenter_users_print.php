...
require_once("include/dbo_callcenter_users_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.CallCenter_users" );
