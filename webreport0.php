...
$b_includes .= '
	...
	li_selected="db";
	$("#tl").html("'."Επιλέξτε τον πίνακα που θα χρησιμοποιήσετε για να δημιουργήσετε την αναφορά:".'");
	$(function() {
...
if(postvalue("sqlname"))
	$b_includes .= '
					...
					$("#radio_custom").click();
					li_selected="custom";
					$("#tl").html("'."Επιλέξτε το SQL Ερώτημα που θα χρησιμοποιήσετε για να δημιουργήσετε την αναφορά:".'");
					';
else
{	
	if(is_wr_db() && count($arr_tables_db))
...
if (@$_SESSION['webreports']['settings']['title'] != "") {
	$xt->assign("report_title",", "."Τίτλος".": ".@$_SESSION['webreports']['settings']['title']);
} else {
